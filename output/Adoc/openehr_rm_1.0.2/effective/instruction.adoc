...
|*narrative*: `xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]` [1..1]
a|Mandatory human-readable version of what the Instruction is about.

|*expiry_time*: `xref:RM:data_types:quantity_package.adoc#_dv_date_time_class[DV_DATE_TIME]` [0..1]
...
|*wf_definition*: `xref:RM:data_types:encapsulated_package.adoc#_dv_parsable_class[DV_PARSABLE]` [0..1]
a|Optional workflow engine executable expression of the Instruction.

|*activities*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:ehr:content_package.adoc#_activity_class[ACTIVITY]>` [0..1]
