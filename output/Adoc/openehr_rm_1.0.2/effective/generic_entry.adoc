...
2+|Inherits: xref:RM:common:archetyped_package.adoc#_pathable_class[PATHABLE], xref:RM:common:archetyped_package.adoc#_locatable_class[LOCATABLE], xref:RM:ehr:content_package.adoc#_content_item_class[CONTENT_ITEM]
...
|*data*: `xref:RM:data_structures:item_structure_package.adoc#_item_tree_class[ITEM_TREE]` [1..1]
