...
|*is_primary*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
...
|*is_changed*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [0..1]
a|True if the content item carried in this container is any kind of change since last send, in repeat sending situations. +
_Inherited from xref:RM:ehr_extract:common_package.adoc#_extract_content_item_class[EXTRACT_CONTENT_ITEM]_

|*is_masked*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [0..1]
...
|*item_type_version*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
a|Version of model or schema used to create the content item.

|*author*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
...
|*creation_time*: `xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_date_time_class[Iso8601_date_time]` [0..1]
...
|*authoriser*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
...
|*authorisation_time*: `xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_date_time_class[Iso8601_date_time]` [0..1]
...
|*version_set_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
a|Version set id of this item in original system, where applicable.

|*system_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
a|Identifier of EMR or other system from which the item was created / extracted. Typically in the form of a domain name.

|*other_details*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>` [0..1]
