...
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>` [0..1]
a|The list of references to other (usually) versioned objects logically in this folder.

|*folders*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:common:directory_package.adoc#_folder_class[FOLDER]>` [0..1]
