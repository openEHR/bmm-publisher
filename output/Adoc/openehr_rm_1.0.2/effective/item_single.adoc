...
|*item*: `xref:RM:data_structures:item_structure_package.adoc#_element_class[ELEMENT]` [1..1]
a|
...
|*as_hierarchy* (): `xref:RM:data_structures:item_structure_package.adoc#_element_class[ELEMENT]` [1..1]
