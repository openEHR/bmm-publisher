...
2+|Inherits: xref:RM:common:archetyped_package.adoc#_pathable_class[PATHABLE], xref:RM:common:archetyped_package.adoc#_locatable_class[LOCATABLE], xref:RM:data_structures:item_structure_package.adoc#_data_structure_class[DATA_STRUCTURE]
...
|*origin*: `xref:RM:data_types:quantity_package.adoc#_dv_date_time_class[DV_DATE_TIME]` [1..1]
a|Time origin of this event history. The first event is not necessarily at the origin point.

|*period*: `xref:RM:data_types:quantity_package.adoc#_dv_duration_class[DV_DURATION]` [0..1]
a|Period between samples in this segment if periodic.

|*duration*: `xref:RM:data_types:quantity_package.adoc#_dv_duration_class[DV_DURATION]` [0..1]
...
|*summary*: `xref:RM:data_structures:item_structure_package.adoc#_item_structure_class[ITEM_STRUCTURE]` [0..1]
a|Optional summary data expressing e.g. text or image which summarises entire History.

|*events*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_structures:history_package.adoc#_event_class[EVENT]<T>>` [0..1]
...
|*as_hierarchy* (): `xref:RM:data_structures:item_structure_package.adoc#_item_class[ITEM]` [1..1]
...
|*is_periodic* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
