...
|*addresses*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:demographic:demographic_package.adoc#_address_class[ADDRESS]>` [1..1]
...
|*purpose* (): `xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]` [1..1]
