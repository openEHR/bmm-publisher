...
|*ehr_id*: `xref:RM:support:identification_package.adoc#_hier_object_id_class[HIER_OBJECT_ID]` [1..1]
a|The id of this EHR.

|*contributions*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>` [0..1]
...
|*ehr_status*: `xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]` [1..1]
a|Reference to EHR_STATUS object for this EHR.

|*ehr_access*: `xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]` [1..1]
a|Reference to EHR_ACCESS object for this EHR.

|*compositions*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>` [0..1]
a|Master list of all Versioned Composition references in this EHR.

|*directory*: `xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]` [0..1]
