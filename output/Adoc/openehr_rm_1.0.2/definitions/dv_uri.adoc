...
h|*1..1*
|*fragment_id* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*1..1*
|*query* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
