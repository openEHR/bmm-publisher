...
h|*1..1*
|*symbol*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]`
...
h|*1..1*
|*limits* (): `xref:RM:data_types:quantity_package.adoc#_dv_ordinal_class[DV_ORDINAL]`
