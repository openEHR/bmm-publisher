...
h|*1..1*
|*archetype_id*: `xref:RM:support:identification_package.adoc#_archetype_id_class[ARCHETYPE_ID]`
a|Globally unique archetype identifier.

h|*0..1*
|*template_id*: `xref:BASE:base_types:identification_package.adoc#_template_id_class[TEMPLATE_ID]`
...
h|*1..1*
|*rm_version*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
