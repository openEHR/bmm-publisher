...
h|*Inherit*
2+|`xref:RM:data_types:quantity_package.adoc#_dv_amount_class[DV_AMOUNT]`, `xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_duration_class[Iso8601_duration]`
