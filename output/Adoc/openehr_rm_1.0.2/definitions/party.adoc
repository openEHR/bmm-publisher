...
h|*0..1*
|*reverse_relationships*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_locatable_ref_class[LOCATABLE_REF]>`
...
h|*1..1*
|*type* (): `xref:RM:data_structures:item_structure_package.adoc#_item_structure_class[ITEM_STRUCTURE]`
