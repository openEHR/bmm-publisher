...
h|*0..1*
|*hyperlink*: `xref:RM:data_types:uri_package.adoc#_dv_uri_class[DV_URI]`
a|Optional link sitting behind a section of plain text or coded term item.

h|*0..1*
|*formatting*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*0..1*
|*mappings*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:text_package.adoc#_term_mapping_class[TERM_MAPPING]>`
