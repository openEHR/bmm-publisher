...
h|*1..1*
|*system_id*: `xref:RM:support:identification_package.adoc#_hier_object_id_class[HIER_OBJECT_ID]`
a|The id of the EHR system on which this EHR was created.

h|*1..1*
|*ehr_id*: `xref:RM:support:identification_package.adoc#_hier_object_id_class[HIER_OBJECT_ID]`
a|The id of this EHR.

h|*0..1*
|*contributions*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
...
h|*1..1*
|*ehr_status*: `xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]`
a|Reference to EHR_STATUS object for this EHR.

h|*1..1*
|*ehr_access*: `xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]`
a|Reference to EHR_ACCESS object for this EHR.

h|*0..1*
|*compositions*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
a|Master list of all Versioned Composition references in this EHR.

h|*0..1*
|*directory*: `xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]`
