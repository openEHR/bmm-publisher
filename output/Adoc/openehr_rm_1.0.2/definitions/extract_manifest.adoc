...
h|*1..1*
|*entities*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:ehr_extract:common_package.adoc#_extract_entity_manifest_class[EXTRACT_ENTITY_MANIFEST]>`
