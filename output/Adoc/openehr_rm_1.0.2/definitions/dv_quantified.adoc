...
h|*Inherit*
2+|`xref:RM:data_types:quantity_package.adoc#_dv_ordered_class[DV_ORDERED]`
...
h|*0..1*
|*magnitude_status*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*0..1*
|*accuracy*: `xref:BASE:foundation_types:overview.adoc#_any_class[Any]`
a|
...
h|*1..1 +
(abstract)*
|*magnitude* (): `xref:BASE:foundation_types:primitive_types.adoc#_ordered_numeric_class[Ordered_Numeric]`
a|

h|*1..1*
|*accuracy_unknown* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
