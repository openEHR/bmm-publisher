...
h|*1..1*
|*is_primary*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
...
h|*0..1*
|*is_changed*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if the content item carried in this container is any kind of change since last send, in repeat sending situations.

h|*0..1*
|*is_masked*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
