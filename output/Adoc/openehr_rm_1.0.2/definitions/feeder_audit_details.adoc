...
h|*0..1*
|*location*: `xref:RM:common:generic_package.adoc#_party_identified_class[PARTY_IDENTIFIED]`
...
h|*0..1*
|*provider*: `xref:RM:common:generic_package.adoc#_party_identified_class[PARTY_IDENTIFIED]`
