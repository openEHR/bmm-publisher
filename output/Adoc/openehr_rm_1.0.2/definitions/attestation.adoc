...
h|*Inherit*
2+|`xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS]`
...
h|*0..1*
|*attested_view*: `xref:RM:data_types:encapsulated_package.adoc#_dv_multimedia_class[DV_MULTIMEDIA]`
a|Optional visual representation of content attested e.g. screen image.

h|*0..1*
|*proof*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Proof of attestation.

h|*0..1*
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:uri_package.adoc#_dv_ehr_uri_class[DV_EHR_URI]>`
...
h|*1..1*
|*is_pending*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
