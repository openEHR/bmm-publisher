...
h|*0..1*
|*creation_time*: `xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_date_time_class[Iso8601_date_time]`
...
h|*0..1*
|*authorisation_time*: `xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_date_time_class[Iso8601_date_time]`
...
h|*0..1*
|*other_details*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>`
