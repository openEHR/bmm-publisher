...
h|*Inherit*
2+|`xref:LANG:bmm3:core_package.adoc#_bmm_package_container_class[BMM_PACKAGE_CONTAINER]`, `xref:LANG:bmm3:core_package.adoc#_bmm_model_metadata_class[BMM_MODEL_METADATA]`
...
h|*0..1*
|*class_definitions*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:LANG:bmm3:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
a|All classes in this model, keyed by type name.

h|*0..1*
|*used_models*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm3:core_package.adoc#_bmm_model_class[BMM_MODEL]>`
...
h|*0..1*
|*modules*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:LANG:bmm3:core_package.adoc#_bmm_module_class[BMM_MODULE]>`
a|All classes in this model, keyed by type name.
...
): `xref:LANG:bmm3:core_package.adoc#_bmm_class_class[BMM_CLASS]`
a|Retrieve the class definition corresponding to `_a_type_name_` (which may contain a generic part).

h|*1..1*
|*type_definition* (): `xref:LANG:bmm3:core_package.adoc#_bmm_class_class[BMM_CLASS]`
...
a_name: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String][1]` +
): `xref:LANG:bmm3:core_package.adoc#_bmm_enumeration_class[BMM_ENUMERATION]`
...
h|*1..1*
|*property_definition* (): `xref:LANG:bmm3:core_package.adoc#_bmm_property_class[BMM_PROPERTY]`
...
h|*1..1*
|*property_definition_at_path* (): `xref:LANG:bmm3:core_package.adoc#_bmm_property_class[BMM_PROPERTY]`
...
h|*1..1*
|*any_class_definition* (): `xref:LANG:bmm3:core_package.adoc#_bmm_simple_class_class[BMM_SIMPLE_CLASS]`
...
h|*1..1*
|*any_type_definition* (): `xref:LANG:bmm3:core_package.adoc#_bmm_simple_type_class[BMM_SIMPLE_TYPE]`
a|`BMM_SIMPLE_TYPE` instance for the `Any` type.

h|*1..1*
|*boolean_type_definition* (): `xref:LANG:bmm3:core_package.adoc#_bmm_simple_type_class[BMM_SIMPLE_TYPE]`
