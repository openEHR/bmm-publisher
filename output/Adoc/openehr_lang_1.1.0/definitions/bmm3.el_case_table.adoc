...
h|*Inherit*
2+|`xref:LANG:bmm3:expression_package.adoc#_el_decision_table_class[EL_DECISION_TABLE]`
...
h|*1..1 +
(redefined)*
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm3:expression_package.adoc#_el_case_class[EL_CASE]<T>>`
a|Members of the chain, equivalent to branches in an if/then/else chain and cases in a case statement.

h|*1..1*
|*test_value*: `xref:LANG:bmm3:expression_package.adoc#_el_value_generator_class[EL_VALUE_GENERATOR]`
