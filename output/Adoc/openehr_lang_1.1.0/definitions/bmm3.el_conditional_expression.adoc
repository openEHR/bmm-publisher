...
h|*Inherit*
2+|`xref:LANG:bmm3:expression_package.adoc#_el_decision_branch_class[EL_DECISION_BRANCH]`
...
h|*1..1*
|*condition*: `xref:LANG:bmm3:expression_package.adoc#_el_expression_class[EL_EXPRESSION]`
