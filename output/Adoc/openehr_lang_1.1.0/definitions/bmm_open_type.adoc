...
h|*1..1*
|*generic_constraint*: `xref:LANG:bmm:core_package.adoc#_bmm_generic_parameter_class[BMM_GENERIC_PARAMETER]`
...
h|*1..1*
|*conformance_type_name* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
