...
h|*Inherit*
2+|`xref:LANG:bmm3:core_package.adoc#_bmm_package_container_class[BMM_PACKAGE_CONTAINER]`
...
h|*0..1*
|*members*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm3:core_package.adoc#_bmm_module_class[BMM_MODULE]>`
...
h|*0..1*
|*root_classes* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm3:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
