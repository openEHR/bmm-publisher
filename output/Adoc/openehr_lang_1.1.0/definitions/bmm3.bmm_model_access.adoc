...
h|*0..1*
|*all_schemas*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:LANG:bmm3:model_access_package.adoc#_bmm_schema_descriptor_class[BMM_SCHEMA_DESCRIPTOR]>`
a|All schemas found and loaded from `_schema_directory_`. Keyed by `_schema_id_`.

h|*0..1*
|*bmm_models*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:LANG:bmm3:core_package.adoc#_bmm_model_class[BMM_MODEL]>`
a|Top-level (root) models in use, keyed by `_model_id_`.

h|*0..1*
|*matching_bmm_models*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:LANG:bmm3:core_package.adoc#_bmm_model_class[BMM_MODEL]>`
...
): `xref:LANG:bmm3:core_package.adoc#_bmm_model_class[BMM_MODEL]`
