...
h|*1..1*
|*target*: `xref:LANG:bmm3:expression_package.adoc#_el_value_generator_class[EL_VALUE_GENERATOR]`
a|The target variable on the notional left-hand side of this assignment.

h|*1..1*
|*source*: `xref:LANG:bmm3:expression_package.adoc#_el_expression_class[EL_EXPRESSION]`
