...
h|*0..1*
|*classes*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
...
h|*0..1*
|*root_classes* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
