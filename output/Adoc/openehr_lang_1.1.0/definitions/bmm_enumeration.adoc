...
h|*0..1*
|*item_values*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<T>`
a|Optional list of specific values. Must be 1:1 with `item_names' list.

h|*1..1*
|*underlying_type_name*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
