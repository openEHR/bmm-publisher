...
h|*0..1*
|*item_values*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm:core_package.adoc#_bmm_primitive_value_class[BMM_PRIMITIVE_VALUE]>`
