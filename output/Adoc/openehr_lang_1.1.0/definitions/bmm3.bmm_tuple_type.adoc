...
h|*Inherit*
2+|`xref:LANG:bmm3:core_package.adoc#_bmm_builtin_type_class[BMM_BUILTIN_TYPE]`
...
h|*1..1*
|*item_types*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:LANG:bmm3:core_package.adoc#_bmm_type_class[BMM_TYPE]>`
