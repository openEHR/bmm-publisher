...
h|*1..1*
|*has_type_substitutions* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|Determine if there are any type substitutions.

h|*0..1*
|*type_substitutions* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>`
