...
h|*Inherit*
2+|`xref:LANG:bmm3:core_package.adoc#_bmm_simple_class_class[BMM_SIMPLE_CLASS]`
...
h|*0..1*
|*item_values*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm3:core_package.adoc#_bmm_primitive_value_class[BMM_PRIMITIVE_VALUE]>`
...
h|*1..1*
|*name_map* (): `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>`
