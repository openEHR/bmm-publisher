...
h|*Inherit*
2+|`xref:LANG:bmm3:statement_package.adoc#_bmm_statement_class[BMM_STATEMENT]`
...
h|*1..1*
|*decision_table*: `xref:LANG:bmm3:statement_package.adoc#_bmm_action_decision_table_class[BMM_ACTION_DECISION_TABLE]`
