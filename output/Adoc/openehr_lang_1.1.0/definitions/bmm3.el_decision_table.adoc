...
h|*Inherit*
2+|`xref:LANG:bmm3:expression_package.adoc#_el_terminal_class[EL_TERMINAL]`
...
h|*1..1*
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm3:expression_package.adoc#_el_decision_branch_class[EL_DECISION_BRANCH]<T>>`
