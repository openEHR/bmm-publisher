...
h|*Inherit*
2+|`xref:LANG:bmm:rm_access_package.adoc#_schema_descriptor_class[SCHEMA_DESCRIPTOR]`
...
h|*0..1*
|*bmm_schema*: `xref:LANG:bmm_persistence_package.adoc#_p_bmm_schema_class[P_BMM_SCHEMA]`
