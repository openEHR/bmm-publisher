...
h|*1..1*
|*container_class*: `xref:LANG:bmm:core_package.adoc#_bmm_generic_class_class[BMM_GENERIC_CLASS]`
a|The type of the container. This converts to the `_root_type_` in `BMM_GENERIC_TYPE`.

h|*1..1*
|*item_type*: `xref:LANG:bmm:core_package.adoc#_bmm_unitary_type_class[BMM_UNITARY_TYPE]`
...
h|*1..1 +
(effected)*
|*unitary_type* (): `xref:LANG:bmm:core_package.adoc#_bmm_unitary_type_class[BMM_UNITARY_TYPE]`
