...
h|*1..1*
|*resource_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*1..1*
|*value_set_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
