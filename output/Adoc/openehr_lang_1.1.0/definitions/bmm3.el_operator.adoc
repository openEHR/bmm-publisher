...
h|*1..1*
|*call*: `xref:LANG:bmm3:expression_package.adoc#_el_function_call_class[EL_FUNCTION_CALL]`
...
h|*1..1*
|*operator_definition* (): `xref:LANG:bmm3:core_package.adoc#_bmm_operator_class[BMM_OPERATOR]`
a|Operator definition derived from `_definition.operator_definition()_`.

h|*1..1*
|*equivalent_call* (): `xref:LANG:bmm3:expression_package.adoc#_el_function_call_class[EL_FUNCTION_CALL]`
