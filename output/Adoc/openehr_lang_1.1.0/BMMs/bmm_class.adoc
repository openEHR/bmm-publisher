...
--------
{
    ...
    "properties": {
        ...
        "properties": {
            "_type": "P_BMM_CONTAINER_PROPERTY",
            "name": "properties",
            "documentation": "Properties defined in this class (subset of `_features_`).",
            "type_def": {
                "container_type": "List",
                "type": "String"
            },
        ...
        "static_properties": {
            ...
            "documentation": "Static properties defined in this class (subset of `_features_`).",
            "type_def": {
                "container_type": "List",
                "type": "String"
            },
        ...
        "functions": {
            "_type": "P_BMM_CONTAINER_PROPERTY",
            "name": "functions",
            "documentation": "Functions defined in this class (subset of `_features_`).",
            "type_def": {
                "container_type": "List",
                "type": "String"
            },
        ...
        "procedures": {
            "_type": "P_BMM_CONTAINER_PROPERTY",
            "name": "procedures",
            "documentation": "Procedures defined in this class (subset of `_features_`).",
            "type_def": {
                "container_type": "List",
                "type": "String"
            },
        ...
        "features": {
            "_type": "P_BMM_CONTAINER_PROPERTY",
            "name": "features",
            "documentation": "Features of this module.",
            "type_def": {
                "container_type": "List",
                "type": "BMM_FEATURE"
            },
