...
|*bmm_schema*: `xref:LANG:bmm3:model_access_package.adoc#_bmm_schema_class[BMM_SCHEMA]` [0..1]
a|Persistent form of model.

|*bmm_model*: `xref:LANG:bmm3:core_package.adoc#_bmm_model_class[BMM_MODEL]` [0..1]
