...
h|*Inherit*
2+|`xref:RM:data_types:quantity_package.adoc#_proportion_kind_enumeration[PROPORTION_KIND]`, `xref:RM:data_types:quantity_package.adoc#_dv_amount_class[DV_AMOUNT]`
...
h|*1..1*
|*numerator*: `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]`
a|Numerator of ratio

h|*1..1*
|*denominator*: `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]`
a|Denominator of ratio.

h|*1..1*
|*type*: `xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]`
...
h|*0..1 +
(redefined)*
|*normal_range*: `xref:RM:data_types:quantity_package.adoc#_dv_interval_class[DV_INTERVAL]<xref:RM:data_types:quantity_package.adoc#_dv_proportion_class[DV_PROPORTION]>`
a|Optional normal range.

h|*0..1 +
(redefined)*
|*other_reference_ranges*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:quantity_package.adoc#_reference_range_class[REFERENCE_RANGE]<xref:RM:data_types:quantity_package.adoc#_dv_proportion_class[DV_PROPORTION]>>`
...
): `xref:RM:data_types:quantity_package.adoc#_dv_proportion_class[DV_PROPORTION]`
