...
h|*0..1*
|*accuracy_is_percent*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
...
h|*0..1 +
(redefined)*
|*accuracy*: `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]`
...
h|*1..1*
|*negative* __alias__ "-" (): `xref:RM:data_types:quantity_package.adoc#_dv_amount_class[DV_AMOUNT]`
