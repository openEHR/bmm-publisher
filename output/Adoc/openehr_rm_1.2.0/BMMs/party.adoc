...
--------
{
    ...
    "functions": {
        ...
        "reverse_relationships": {
            ...
            "post_conditions": {
                "Post_reverse_relationships_validity": "Result /= Void implies (not Result.empty and then Result.for_all (item | repository (\"demographics\").all_party_relationships.has_object (item) and then repository (\"demographics\").all_party_relationships.object (item).target = self))"
            },
            "result": {
