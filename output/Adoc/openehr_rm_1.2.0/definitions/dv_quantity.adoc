...
h|*0..1*
|*units_system*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*0..1*
|*units_display_name*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
): `xref:RM:data_types:quantity_package.adoc#_dv_quantity_class[DV_QUANTITY]`
