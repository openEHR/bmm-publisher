...
h|*Inherit*
2+|`xref:RM:data_types:quantity_package.adoc#_dv_amount_class[DV_AMOUNT]`, `xref:BASE:foundation_types:time_types.adoc#_iso8601_duration_class[Iso8601_duration]`
...
h|*1..1 +
(redefined)*
|*negative* __alias__ "-" (): `xref:RM:data_types:quantity_package.adoc#_dv_duration_class[DV_DURATION]`
