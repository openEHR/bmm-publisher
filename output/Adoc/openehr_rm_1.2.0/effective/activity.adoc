...
|*timing*: `xref:RM:data_types:encapsulated_package.adoc#_dv_parsable_class[DV_PARSABLE]` [0..1]
...
|*action_archetype_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [1..1]
