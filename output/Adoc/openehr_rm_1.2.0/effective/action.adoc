...
|*ism_transition*: `xref:RM:ehr:content_package.adoc#_ism_transition_class[ISM_TRANSITION]` [1..1]
a|Details of transition in the Instruction state machine caused by this Action.

|*instruction_details*: `xref:RM:ehr:content_package.adoc#_instruction_details_class[INSTRUCTION_DETAILS]` [0..1]
a|Details of the Instruction that caused this Action to be performed, if there was one.

|*description*: `xref:RM:data_structures:item_structure_package.adoc#_item_structure_class[ITEM_STRUCTURE]` [1..1]
