...
h|*1..1*
|*type_definition* (): `xref:LANG:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]`
...
h|*1..1*
|*any_class_definition* (): `xref:LANG:bmm:core_package.adoc#_bmm_simple_class_class[BMM_SIMPLE_CLASS]`
...
h|*1..1*
|*any_type_definition* (): `xref:LANG:bmm:core_package.adoc#_bmm_simple_type_class[BMM_SIMPLE_TYPE]`
a|`BMM_SIMPLE_TYPE` instance for the `Any` type.

h|*1..1*
|*boolean_type_definition* (): `xref:LANG:bmm:core_package.adoc#_bmm_simple_type_class[BMM_SIMPLE_TYPE]`
