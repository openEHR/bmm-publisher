...
h|*1..1*
|*generic_parameters*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm:core_package.adoc#_bmm_unitary_type_class[BMM_UNITARY_TYPE]>`
...
h|*1..1 +
(redefined)*
|*base_class*: `xref:LANG:bmm:core_package.adoc#_bmm_generic_class_class[BMM_GENERIC_CLASS]`
...
h|*1..1*
|*effective_base_class* (): `xref:LANG:bmm:core_package.adoc#_bmm_generic_class_class[BMM_GENERIC_CLASS]`
