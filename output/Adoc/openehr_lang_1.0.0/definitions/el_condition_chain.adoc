...
h|*1..1 +
(redefined)*
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:LANG:bmm:expression_package.adoc#_el_conditional_expression_class[EL_CONDITIONAL_EXPRESSION]>`
