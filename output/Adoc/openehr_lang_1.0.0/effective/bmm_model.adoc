...
|*rm_publisher*: `link:/classes/String[String] ` [1..1]
...
|*rm_release*: `link:/classes/String[String] ` [1..1]
a|Release of model expressed in the schema as a 3-part numeric, e.g. "3.1.0" . +
_Inherited from xref:LANG:bmm:core_package.adoc#_bmm_model_metadata_class[BMM_MODEL_METADATA]_

|*class_definitions*: `link:/classes/Hash[Hash] <link:/classes/String[String] ,link:/classes/BMM_CLASS[BMM_CLASS] >` [0..1]
a|All classes in this model, keyed by type name.

|*used_models*: `link:/classes/List[List] <xref:LANG:bmm:core_package.adoc#_bmm_model_class[BMM_MODEL]>` [0..1]
...
|*model_id* (): `link:/classes/String[String] ` [1..1]
...
|*primitive_types* (): `link:/classes/List[List] <link:/classes/String[String] >` [0..1]
a|List of keys in `_class_definitions_` of items marked as primitive types.

|*enumeration_types* (): `link:/classes/List[List] <link:/classes/String[String] >` [0..1]
...
): `link:/classes/List[List] <link:/classes/String[String] >` [0..1]
...
): `link:/classes/List[List] <link:/classes/String[String] >` [1..1]
