...
--------
{
    ...
    "functions": {
        ...
        "has_version_at_time": {
            ...
            "documentation": "True if a version for time  'a_time' exists. ",
            "parameters": {
                "a_ver_id": {
        ...
        "has_version_id": {
            "name": "has_version_id",
            "documentation": "True if a version with an_id exists. ",
            "parameters": {
                "a_ver_id": {
                    "_type": "P_BMM_SINGLE_FUNCTION_PARAMETER",
                    "name": "a_ver_id",
        ...
        "version_with_id": {
            ...
            "documentation": "Return the version with id =  'a_ver_id'. \n",
            "parameters": {
                "a_ver_id": {
                    "_type": "P_BMM_SINGLE_FUNCTION_PARAMETER",
                    "name": "a_ver_id",
        ...
        "is_original_version": {
            ...
            "documentation": "True if version with an_id is an ORIGINAL_VERSION. ",
            "parameters": {
                "a_ver_id": {
                    "_type": "P_BMM_SINGLE_FUNCTION_PARAMETER",
                    "name": "a_ver_id",
        ...
        "version_at_time": {
            ...
            "documentation": "Return the version for time  'a_time'. ",
            "parameters": {
                "a_time": {
                    "_type": "P_BMM_SINGLE_FUNCTION_PARAMETER",
                    "name": "a_time",
