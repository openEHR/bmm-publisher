...
h|*0..1*
|*originating_system_item_ids*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>`
a|Identifiers used for the item in the originating system, e.g. filler and placer ids.

h|*0..1*
|*feeder_system_item_ids*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>`
a|Identifiers used for the item in the feeder system, where the feeder system is distinct from the originating system.

h|*0..1*
|*original_content*: `xref:RM:data_types:encapsulated_package.adoc#_dv_encapsulated_class[DV_ENCAPSULATED]`
...
h|*1..1*
|*originating_system_audit*: `xref:RM:common:archetyped_package.adoc#_feeder_audit_details_class[FEEDER_AUDIT_DETAILS]`
a|Any audit information for the information item from the originating system.

h|*0..1*
|*feeder_system_audit*: `xref:RM:common:archetyped_package.adoc#_feeder_audit_details_class[FEEDER_AUDIT_DETAILS]`
