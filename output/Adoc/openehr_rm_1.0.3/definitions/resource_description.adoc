...
h|*1..1*
|*parent_resource*: `xref:RM:common:resource_package.adoc#_authored_resource_class[AUTHORED_RESOURCE]` +
`{default{nbsp}={nbsp}0..1}`
a|Reference to owning resource.

h|*1..1*
|*details*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:common:resource_package.adoc#_resource_description_item_class[RESOURCE_DESCRIPTION_ITEM]>`
