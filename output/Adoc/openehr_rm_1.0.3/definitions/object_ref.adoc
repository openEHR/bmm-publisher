...
h|*1..1*
|*id_namespace*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*1..1*
|*id*: `xref:RM:support:identification_package.adoc#_object_id_class[OBJECT_ID]`
