...
h|*1..1*
|*author*: `xref:RM:common:generic_package.adoc#_party_proxy_class[PARTY_PROXY]`
...
h|*1..1*
|*content*: `xref:RM:ehr_extract:message_package.adoc#_message_content_class[MESSAGE_CONTENT]`
