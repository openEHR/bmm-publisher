...
h|*Inherit*
2+|`xref:RM:data_types:basic_package.adoc#_data_value_class[DATA_VALUE]`, `xref:BASE:foundation_types:primitive_types.adoc#_ordered_class[Ordered]`
...
h|*0..1*
|*normal_status*: `xref:RM:data_types:text_package.adoc#_code_phrase_class[CODE_PHRASE]`
...
h|*0..1*
|*normal_range*: `xref:RM:data_types:quantity_package.adoc#_dv_interval_class[DV_INTERVAL]`
a|Optional normal range.

h|*0..1*
|*other_reference_ranges*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:quantity_package.adoc#_reference_range_class[REFERENCE_RANGE]<xref:RM:data_types:quantity_package.adoc#_dv_ordered_class[DV_ORDERED]>>`
...
h|*1..1*
|*is_simple* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
