...
h|*1..1*
|*function*: `xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]`
...
h|*0..1*
|*mode*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]`
a|Optional field for recording the 'mode' of the performer / activity interaction, e.g. present, by telephone, by email etc.

h|*0..1*
|*time*: `xref:RM:data_types:quantity_package.adoc#_dv_interval_class[DV_INTERVAL]<xref:RM:data_types:quantity_package.adoc#_dv_date_time_class[DV_DATE_TIME]>`
...
h|*1..1*
|*performer*: `xref:RM:common:generic_package.adoc#_party_proxy_class[PARTY_PROXY]`
