...
h|*1..1*
|*current_state*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]`
a|The ISM current state. Coded by openEHR terminology group Instruction states.

h|*0..1*
|*transition*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]`
...
h|*0..1*
|*careflow_step*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]`
...
h|*0..1*
|*reason*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]>`
