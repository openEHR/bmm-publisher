...
h|*0..1*
|*ehr_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|EHR / EMR identifier for the entity at the target system.

h|*0..1*
|*subject_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Subject (i.e. patient or similar) identifier for the entity at the target system.

h|*0..1*
|*other_ids*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>`
...
h|*0..1*
|*item_list*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>`
