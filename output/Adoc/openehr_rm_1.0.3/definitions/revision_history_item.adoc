...
h|*1..1*
|*version_id*: `xref:RM:support:identification_package.adoc#_object_version_id_class[OBJECT_VERSION_ID]`
a|Version identifier for this revision.

h|*1..1*
|*audits*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:common:generic_package.adoc#_audit_details_class[AUDIT_DETAILS]>`
