...
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_structures:item_structure_package.adoc#_element_class[ELEMENT]>` [0..1]
...
|*item_count* (): `xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]` [1..1]
a|Count of all items.

|*names* (): `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]>` [0..1]
