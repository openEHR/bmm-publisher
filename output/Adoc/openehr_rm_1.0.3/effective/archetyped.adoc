...
|*archetype_id*: `xref:RM:support:identification_package.adoc#_archetype_id_class[ARCHETYPE_ID]` [1..1]
a|Globally unique archetype identifier.

|*template_id*: `xref:RM:support:identification_package.adoc#_template_id_class[TEMPLATE_ID]` [0..1]
