...
2+|Inherits: xref:RM:common:archetyped_package.adoc#_pathable_class[PATHABLE], xref:RM:common:archetyped_package.adoc#_locatable_class[LOCATABLE], xref:RM:data_structures:item_structure_package.adoc#_item_class[ITEM]
...
|*null_flavour*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]` [0..1]
a|Flavour of null value, e.g. indeterminate, not asked etc.

|*value*: `xref:RM:data_types:basic_package.adoc#_data_value_class[DATA_VALUE]` [0..1]
...
|*is_null* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
