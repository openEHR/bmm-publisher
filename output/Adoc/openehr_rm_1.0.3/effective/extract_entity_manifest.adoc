...
|*ehr_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
a|EHR / EMR identifier for the entity at the target system.

|*subject_id*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [0..1]
a|Subject (i.e. patient or similar) identifier for the entity at the target system.

|*other_ids*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]>` [0..1]
...
|*item_list*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>` [0..1]
