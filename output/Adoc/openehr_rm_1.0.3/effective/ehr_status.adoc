...
|*subject*: `xref:RM:common:generic_package.adoc#_party_self_class[PARTY_SELF]` [1..1]
...
|*is_queryable*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
a|True if this EHR should be included in population queries, i.e. if this EHR is considered active in the population.

|*is_modifiable*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]` [1..1]
