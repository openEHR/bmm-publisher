...
|*other_input_version_uids*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_object_version_id_class[OBJECT_VERSION_ID]>` [0..1]
