...
2+|Inherits: xref:RM:common:archetyped_package.adoc#_pathable_class[PATHABLE], xref:RM:common:archetyped_package.adoc#_locatable_class[LOCATABLE], xref:RM:demographic:demographic_package.adoc#_party_class[PARTY]
...
|*reverse_relationships*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:support:identification_package.adoc#_locatable_ref_class[LOCATABLE_REF]>` [0..1]
...
|*performer*: `xref:RM:support:identification_package.adoc#_party_ref_class[PARTY_REF]` [1..1]
