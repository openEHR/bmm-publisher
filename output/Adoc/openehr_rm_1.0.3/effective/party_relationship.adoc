...
|*source*: `xref:RM:support:identification_package.adoc#_party_ref_class[PARTY_REF]` [1..1]
a|Source of relationship.

|*target*: `xref:RM:support:identification_package.adoc#_party_ref_class[PARTY_REF]` [1..1]
