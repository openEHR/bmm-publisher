...
2+|Inherits: xref:RM:common:archetyped_package.adoc#_pathable_class[PATHABLE], xref:RM:common:archetyped_package.adoc#_locatable_class[LOCATABLE], xref:RM:ehr_extract:common_package.adoc#_extract_chapter_class[EXTRACT_CHAPTER]
...
|*items*: `xref:BASE:foundation_types:structure_types.adoc#_list_class[List]<xref:RM:ehr_extract:common_package.adoc#_extract_item_class[EXTRACT_ITEM]>` [0..1]
a|The information content of this chapter. +
_Inherited from xref:RM:ehr_extract:common_package.adoc#_extract_chapter_class[EXTRACT_CHAPTER]_

|*extract_id_key*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]` [1..1]
